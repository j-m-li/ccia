...
Preprocessor *cpp_new(void) {
    ...
    cpp_define_macro(cpp, "__riscv", "1");
    cpp_define_macro(cpp, "__riscv__", "1");
    cpp_define_macro(cpp, "__riscv_xlen", "32");
    cpp_define_macro(cpp, "__riscv_i", "1");
    ...
    cpp_define_macro(cpp, "__CCIA_RISCV32__", "1");
